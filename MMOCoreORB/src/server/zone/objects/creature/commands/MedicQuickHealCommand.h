...
#ifndef MedicQuickHealCommand_H_
#define MedicQuickHealCommand_H_

#include "server/zone/objects/scene/SceneObject.h"
#include "server/zone/ZoneServer.h"
#include "server/zone/managers/player/PlayerManager.h"

class MedicQuickHealCommand : public QueueCommand {
	int mindCost;
	int mindWoundCost;
...
public:
	...
	MedicQuickHealCommand(const String& name, ZoneProcessServer* server)
...
#endif //MedicQuickHealCommand_H_
