...
void PetControlDeviceImplementation::callObject(CreatureObject* player, bool initialCall) {
	...
	if (player->getCurrentCamp() == nullptr && player->getCityRegion() == nullptr && !ghost->isPrivileged() && !isBombDroid && petType != PetManager::HIRELING) { //Ethan edit 1-9-25 (HIRELING) - Added "&& !petType == PetManager::HIRELING" 
