npcVendorGenericConvoTemplate = ConvoTemplate:new {
	initialScreen = "conv_start",
	templateType = "Lua",
	luaClassHandler = "NPCVendorGenericConvoHandler",
	screens = {}
}

conv_start = ConvoScreen:new {
	id = "conv_start",
	customDialogText = "Welcome traveler. I sell many wares that would be useful to ", -- Welcome traveler. I am a buyer of goods that most would deem as junk. If you are interested I will look through what you have to offer and set a price for anything that I wish to buy. I also have come across some other items of interest that I am looking to get rid of.
	stopConversation = "false",
	options = {
		{"Could I take a look at your inventory?", "start_vendor"}, --Ethan edit 5-11-24 (JUNK DEALER VENDOR)
	}
}
npcVendorGenericConvoTemplate:addScreen(conv_start);

no_loot = ConvoScreen:new {
	id = "no_loot",
	customDialogText = "That is too bad. Please come again if you have need of wares.", -- That is to bad. Remember to come visit me in the future if you happen to come across anything I would be interested in.
	stopConversation = "true",
	options = {}
}
npcVendorGenericConvoTemplate:addScreen(no_loot);
...
npcVendorGenericConvoTemplate:addScreen(start_vendor);
...
npcVendorGenericConvoTemplate:addScreen(vendor_weapon);
	...
	npcVendorGenericConvoTemplate:addScreen(wares_pistol);
	...
	npcVendorGenericConvoTemplate:addScreen(wares_rifle);
	...
	npcVendorGenericConvoTemplate:addScreen(wares_carbine);
	...
	wares_onehanded = ConvoScreen:new {
		...
		stopConversation = "true",
		options = {}
	}npcVendorGenericConvoTemplate:addScreen(wares_onehanded);
	...
	wares_polearm = ConvoScreen:new {
		...
		stopConversation = "true",
		options = {}
	}npcVendorGenericConvoTemplate:addScreen(wares_polearm);
	...
	wares_twohanded = ConvoScreen:new {
		...
		stopConversation = "true",
		options = {}
	}npcVendorGenericConvoTemplate:addScreen(wares_twohanded);
	...
	wares_unarmed = ConvoScreen:new {
		...
		stopConversation = "true",
		options = {}
	}npcVendorGenericConvoTemplate:addScreen(wares_unarmed);
	...
	wares_heavyweapon = ConvoScreen:new {
		...
		stopConversation = "true",
		options = {}
	}npcVendorGenericConvoTemplate:addScreen(wares_heavyweapon);
	...
	wares_munition = ConvoScreen:new {	
		...
		stopConversation = "true",
		options = {}
	}npcVendorGenericConvoTemplate:addScreen(wares_munition);
	...
	wares_powerup = ConvoScreen:new {
		...
		stopConversation = "true",
		options = {}
	}npcVendorGenericConvoTemplate:addScreen(wares_powerup);
...
npcVendorGenericConvoTemplate:addScreen(vendor_armor);
...
npcVendorGenericConvoTemplate:addScreen(wares_armorpsg);
...
npcVendorGenericConvoTemplate:addScreen(wares_armorhelm);
...
npcVendorGenericConvoTemplate:addScreen(wares_armorchest);
...
npcVendorGenericConvoTemplate:addScreen(wares_armorleg);
...
npcVendorGenericConvoTemplate:addScreen(wares_armorarm);
...
npcVendorGenericConvoTemplate:addScreen(wares_armoraccessory);
...
npcVendorGenericConvoTemplate:addScreen(vendor_wearables);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingapron);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingbackpack);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingbandolier);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingbelt);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingbikini);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingbodysuit);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingboots);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingbracelet);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingnecklace);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingpants);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingring);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingshirt);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingrobe);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingshoes);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingskirt);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingvest);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingwookie);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingbustier);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingdress);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothinggloves);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothinghat);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingjacket);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingithorianchest);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingithorianheadwear);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingithorianhandwear);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingithorianjewelry);
...
npcVendorGenericConvoTemplate:addScreen(wares_clothingithorianpants);
...
npcVendorGenericConvoTemplate:addScreen(vendor_medicine);
...
npcVendorGenericConvoTemplate:addScreen(wares_stim);
...
npcVendorGenericConvoTemplate:addScreen(wares_woundpack);
...
npcVendorGenericConvoTemplate:addScreen(wares_medpackcure);
...
npcVendorGenericConvoTemplate:addScreen(wares_medpackdisease);
...
npcVendorGenericConvoTemplate:addScreen(wares_enhacement);
...
npcVendorGenericConvoTemplate:addScreen(wares_medpackpoison);
...
wares_petstim = ConvoScreen:new {
	...
	stopConversation = "true",
	options = {}
}npcVendorGenericConvoTemplate:addScreen(wares_petstim);
...
npcVendorGenericConvoTemplate:addScreen(vendor_chef);
...
npcVendorGenericConvoTemplate:addScreen(wares_dessert);
...
npcVendorGenericConvoTemplate:addScreen(wares_food);
...
npcVendorGenericConvoTemplate:addScreen(wares_drink);
...
npcVendorGenericConvoTemplate:addScreen(vendor_component);
...
npcVendorGenericConvoTemplate:addScreen(wares_compchef);
...
npcVendorGenericConvoTemplate:addScreen(wares_comparmor);
...
npcVendorGenericConvoTemplate:addScreen(wares_compbio);
...
npcVendorGenericConvoTemplate:addScreen(wares_compchemistry);
...
npcVendorGenericConvoTemplate:addScreen(wares_compclothing);
...
npcVendorGenericConvoTemplate:addScreen(wares_compdroid);
...
npcVendorGenericConvoTemplate:addScreen(wares_compartisan);
...
npcVendorGenericConvoTemplate:addScreen(wares_compshipwright);
...
npcVendorGenericConvoTemplate:addScreen(wares_compstructure);
...
npcVendorGenericConvoTemplate:addScreen(wares_compweapon);
...
npcVendorGenericConvoTemplate:addScreen(wares_tools);
...
npcVendorGenericConvoTemplate:addScreen(vendor_scout);
...
npcVendorGenericConvoTemplate:addScreen(wares_trap);
...
npcVendorGenericConvoTemplate:addScreen(wares_camo);
...
npcVendorGenericConvoTemplate:addScreen(wares_camp);
...
npcVendorGenericConvoTemplate:addScreen(vendor_installation);
...
npcVendorGenericConvoTemplate:addScreen(wares_installation);
...
npcVendorGenericConvoTemplate:addScreen(wares_city);
...
npcVendorGenericConvoTemplate:addScreen(wares_house);
...
npcVendorGenericConvoTemplate:addScreen(wares_furniture);
...
npcVendorGenericConvoTemplate:addScreen(vendor_bio);
...
npcVendorGenericConvoTemplate:addScreen(wares_pets);
...
npcVendorGenericConvoTemplate:addScreen(vendor_droid);
...
npcVendorGenericConvoTemplate:addScreen(wares_droid);
...
npcVendorGenericConvoTemplate:addScreen(wares_droidassc);
...
npcVendorGenericConvoTemplate:addScreen(vendor_misc);
...
npcVendorGenericConvoTemplate:addScreen(wares_fireworks);
...
npcVendorGenericConvoTemplate:addScreen(wares_misc);
...
npcVendorGenericConvoTemplate:addScreen(vendor_smuggler);
...
npcVendorGenericConvoTemplate:addScreen(wares_slicing);
...
npcVendorGenericConvoTemplate:addScreen(wares_spice);
...
npcVendorGenericConvoTemplate:addScreen(vendor_ship);
...
npcVendorGenericConvoTemplate:addScreen(wares_spacecustomization);
...
npcVendorGenericConvoTemplate:addScreen(wares_spacechassis);
...
npcVendorGenericConvoTemplate:addScreen(wares_spacepart);
...
npcVendorGenericConvoTemplate:addScreen(wares_spacemissile);
...
npcVendorGenericConvoTemplate:addScreen(vendor_entertainer);
...
npcVendorGenericConvoTemplate:addScreen(wares_instrument);
...
npcVendorGenericConvoTemplate:addScreen(vendor_vehicle);
...
npcVendorGenericConvoTemplate:addScreen(wares_vehicle);
...
npcVendorGenericConvoTemplate:addScreen(vendor_hireling);
...
npcVendorGenericConvoTemplate:addScreen(hires_marksman);
...
npcVendorGenericConvoTemplate:addScreen(hires_brawler);

hires_tank = ConvoScreen:new {
	id = "hires_tank",
	customDialogText = "Here are the bodyguard contracts I have available.",
	stopConversation = "true",
	options = {}
}
npcVendorGenericConvoTemplate:addScreen(hires_tank);
...
npcVendorGenericConvoTemplate:addScreen(resource_resource)
...
npcVendorGenericConvoTemplate:addScreen(wares_battery);
...
npcVendorGenericConvoTemplate:addScreen(wares_deed_city_deed);
...
npcVendorGenericConvoTemplate:addScreen(wares_deed_pet_deed);
...
npcVendorGenericConvoTemplate:addScreen(wares_deed_vehicle_deed);
...
npcVendorGenericConvoTemplate:addScreen(wares_droid_battery);
...
npcVendorGenericConvoTemplate:addScreen(wares_firework);
...
npcVendorGenericConvoTemplate:addScreen(wares_loot_loot_schematic);
...
npcVendorGenericConvoTemplate:addScreen(wares_recycler);
...
npcVendorGenericConvoTemplate:addScreen(wares_scout_camp);
...
npcVendorGenericConvoTemplate:addScreen(wares_survey_tool);

--End Ethan edit 5-10-24 (JUNK DEALER VENDOR)

addConversationTemplate("npcVendorGenericConvoTemplate", npcVendorGenericConvoTemplate);
