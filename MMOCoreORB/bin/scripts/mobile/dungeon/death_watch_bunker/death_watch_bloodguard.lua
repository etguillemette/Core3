death_watch_bloodguard = Creature:new {
	...
	lootGroups = {
		{
			groups = {
				...
				{group = "death_watch_bunker_lieutenants", chance = 6500000}, --Ethan edit 1-14-25 (LOOT BOOST) was 3500000
	...
	primaryAttacks = merge(bountyhuntermaster,marksmanmaster,brawlermaster,tkamaster),
	secondaryAttacks = { }
}
