...
--Ethan edit 1-8-25 (HIRELING) adding medic class:
medicnovice = {{"healhealthself1",""},{"healactionself1",""}}
medicmid = {{"healhealthself2",""},{"healactionself2",""}}
medicmaster = {{"healallself1",""},{"healallself2",""}}

--Ethan edit 1-8-25 (HIRELING) adding some crowd control abilities:
ccmeleenovice = {{"warcry1",""}}
ccmeleemid = {{"taunt",""},{"warcry1",""}}
ccmeleemaster = {{"taunt",""},{"warcry1",""},{"warcry2",""}}

--Ethan edit 1-8-25 (HIRELING) Smuggler abilities
smugglernovice = {{"panicshot",""}}
