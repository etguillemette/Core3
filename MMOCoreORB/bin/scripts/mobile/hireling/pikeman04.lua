pikeman04 = Creature:new {
	...
	primaryAttacks = { },
	secondaryAttacks = merge(brawlermaster,pikemanmid),
	defaultAttack = "polearmspinattack1",
}

CreatureTemplates:addCreatureTemplate(pikeman04,"pikeman04")