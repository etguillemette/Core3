carbineer06 = Creature:new {
	...
	primaryWeapon = "carbine_nym_slugthrower",
	...
	primaryAttacks = merge(medicmaster,marksmanmaster,carbineermaster),
	secondaryAttacks = { },
}

CreatureTemplates:addCreatureTemplate(carbineer06,"carbineer06")