...
function JantaCaveScreenPlay:spawnMobiles()
	...
	spawnMobile("dantooine", "janta_hunter",900,65.7,-54.5,-152.7,-101,529327)
	spawnMobile("dantooine", "janta_hunter",900,-5.4,-64.2,-234.8,-43,529329)
	spawnMobile("dantooine", "janta_hunter",900,-97.6,-72.7,-174.4,71,529330)
	spawnMobile("dantooine", "janta_hunter",900,-32.3,-70.8,-85.9,-168,529331)
	...
	spawnMobile("dantooine", "janta_primalist",900,45.4,-46.2,-93.1,-21,529326)
	...
	spawnMobile("dantooine", "janta_primalist",900,-68.8,-70.2,-88.8,63,529331)
	...
	spawnMobile("dantooine", "janta_scout",900,-0.9,-45,-141.7,18,529327)
	spawnMobile("dantooine", "janta_scout",900,-4.8,-65.5,-209.6,-94,529329)
	spawnMobile("dantooine", "janta_scout",900,-94.5,-101.9,-143.1,87,529330)
	spawnMobile("dantooine", "janta_scout",900,-113.9,-69.4,-124.1,88,529330)
	...
	spawnMobile("dantooine", "janta_tribesman",900,11,-40.9,-69.7,-58,529325)
	spawnMobile("dantooine", "janta_tribesman",900,60.3,-55.7,-154.6,72,529327)
	spawnMobile("dantooine", "janta_tribesman",900,-8.2,-64,-229.5,-76,529329)
	spawnMobile("dantooine", "janta_tribesman",900,-62.2,-70.3,-87.2,-136,529331)
