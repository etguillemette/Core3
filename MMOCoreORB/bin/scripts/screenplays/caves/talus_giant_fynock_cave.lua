...
function TalusGiantFynockCaveScreenPlay:spawnMobiles()    
	...
	spawnMobile("talus", "frenzied_fynock_guardian", 300, 62.0, -48.8, -178.1, -28, 5625520)

	spawnMobile("talus", "frenzied_fynock_guardian", 300, -10.8, -55.1, -261.8, -38, 5625522)
	...
	spawnMobile("talus", "frenzied_fynock_guardian", 300, -73.3, -91.3, -160.7, 30, 5625523)
