...
function AfarathuCaveScreenPlay:spawnMobiles()
	...
	spawnMobile("corellia", "afarathu_savage", 300, -1.7, -45.8, -147.8, 0, 6035624)
	spawnMobile("corellia", "afarathu_savage", 300, -11.0, -44.4, -136.4, 0, 6035624)
	spawnMobile("corellia", "afarathu_savage", 300, -4.2, -64.0, -234.2, 0, 6035626)
	spawnMobile("corellia", "afarathu_savage", 300, -21.7, -65.4, -244.6, 0, 6035626)
