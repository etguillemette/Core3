...
function BloodRazerTransportScreenPlay:spawnMobiles()
	...
	spawnMobile("lok", "thug", 300, 3639.3, 0.9, 2183.9, -90, 0)
	spawnMobile("lok", "thug", 300, -5.2, 0, 3.8, 90, 568777)
	spawnMobile("lok", "thug", 300, 4.4, 0, 3.7, -140, 568751)
	spawnMobile("lok", "thug", 300, 3.8, 0, 1.3, -90, 568751)
	spawnMobile("lok", "thug", 300, 4.2, 0, -3.9, -21, 568759)
