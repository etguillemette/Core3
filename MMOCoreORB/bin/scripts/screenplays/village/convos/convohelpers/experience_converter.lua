...
ExperienceConverter = ScreenPlay:new {
	xpConversion = {
		combat = {
			...
			{ "bountyhunter", 1 },
			{ "combat_general", 1 },
			{ "combat_meleespecialize_onehand", 6 },
			{ "combat_meleespecialize_polearm", 6 },
			{ "combat_meleespecialize_twohand", 6 },
			{ "combat_meleespecialize_unarmed", 6 },
			{ "combat_rangedspecialize_carbine", 6 },
			{ "combat_rangedspecialize_heavy", 6 },
			{ "combat_rangedspecialize_pistol", 6 },
			{ "combat_rangedspecialize_rifle", 6 },
			{ "squadleader", 18 }
		},
		senses = {
			...
			{ "creaturehandler", 2 },
			{ "dance", 2 },
			{ "entertainer_healing", 2 },
			{ "imagedesigner", 2 },
			{ "medical", 2 },
			{ "merchant", 1 },
			{ "music", 2 },
			{ "political", 1 },
			{ "resource_harvesting_inorganic", 2 },
			{ "scout", 2 },
			{ "slicing", 1 },
			{ "trapping", 5 },
			{ "underworld", 1 }, --Ethan edit 1-20-25 (SMUGGLER REVAMP)
		},
		reflex = {
			--{ "bountyhunter", 5 },
			--{ "combat_general", 3 },
