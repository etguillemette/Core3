...
object_tangible_veteran_reward_shared_resource = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/veteran_reward/shared_resource_purchase_deed.iff"
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/eqp_tool_datapad.apt",
	arrangementDescriptorFilename = "",
...
ObjectTemplates:addClientTemplate(object_tangible_veteran_reward_shared_resource_purchase_deed, "object/tangible/veteran_reward/shared_resource_purchase_deed.iff")
